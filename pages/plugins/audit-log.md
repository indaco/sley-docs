...
description: "Track version change history with author, timestamp, commit SHA, and branch metadata for compliance and debugging with JSON or YAML format"
head:
  - - meta
    - name: keywords
      content: sley, audit log, version history, tracking, compliance, metadata, changelog, git history, audit trail
---
...
<PluginMeta :enabled="false" type="logger" />
...
View the [audit-log.yaml example](https://github.com/indaco/sley/blob/main/docs/plugins/examples/audit-log.yaml) for all available options.
:::
