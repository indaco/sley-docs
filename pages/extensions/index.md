...
Extensions are for advanced customization when built-in plugins don't meet your needs — such as custom team workflows, external tool integration, or prototyping new features before they become plugins. Most users only need [Plugins](/plugins/). See [Plugins vs Extensions](/plugins/#when-to-use-plugins-vs-extensions) for a detailed comparison.
:::
...
::: tip Extensions Run Before Plugin Validations
...
See [Execution Order](/plugins/#execution-order) for the complete flow diagram.
:::
