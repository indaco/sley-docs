---
title: "Docker Tag Sync Extension"
description: "Automatically tag and push Docker images with version numbers after bumps. Bash extension with registry push and latest tag support"
head:
  - - meta
    - name: keywords
      content: sley, docker, container, image tagging, registry, post-bump hook, automation, Bash extension, CI/CD
---
...
<ExtensionMeta hook="post-bump" language="Bash" version="1.0.0" repo="https://github.com/indaco/sley/tree/main/contrib/extensions/docker-tag-sync" />
...
- [CI/CD Integration](/guide/ci-cd) - Automate Docker tagging in pipelines
- [Usage Guide](/guide/usage) - Version bump commands
- [.sley.yaml Reference](/reference/sley-yaml) - Extension configuration
- [Troubleshooting](/guide/troubleshooting/) - Common Docker integration issues
